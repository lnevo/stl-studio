...
(function (global) {
  ...
  defineBlocks([
    ...
    {
      type: 'stl_on_group_start',
      message0: '[ON(] OR NOT nest start ( … )',
      previousStatement: null,
      nextStatement: null,
      colour: '#c47c30',
    ...
    {
      type: 'stl_x_group_start',
      message0: '[X(] XOR nest start ( … )',
      previousStatement: null,
      nextStatement: null,
      colour: '#c47c30',
    ...
    {
      type: 'stl_xn_group_start',
      message0: '[XN(] XOR NOT nest start ( … )',
      previousStatement: null,
      nextStatement: null,
      colour: '#c47c30',
    ...
    },
    {
      ...
      nextStatement: null,
      colour: '#c47c30',
      tooltip: 'End of a nest started by O(, ON(, A(, X(, or XN(. Must match each “nest start” block so the logic is correct.',
    },
    {
      type: 'stl_group',
